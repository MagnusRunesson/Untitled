...
fileid_herotest_sprite_planar           equ 3
fileid_herotest_big_sprite_chunky       equ 4
fileid_herotest_big_palette             equ 5
fileid_herotest_big_sprite              equ 6
fileid_herotest_big_sprite_planar       equ 7
fileid_testsprite_sprite_chunky         equ 8
fileid_testsprite_palette               equ 9
fileid_testsprite_sprite                equ 10
fileid_testsprite_sprite_planar         equ 11
fileid_testsprite2_sprite_chunky        equ 12
fileid_testsprite2_palette              equ 13
fileid_testsprite2_sprite               equ 14
fileid_testsprite2_sprite_planar        equ 15
fileid_testtiles_bank                   equ 16
fileid_testtiles_map                    equ 17
fileid_testtiles_palette                equ 18
fileid_testtiles_planar                 equ 19
...
FileIDMap:
	...
	dc.w	_data_herotest_sprite_planar_pos,_data_herotest_sprite_planar_length
	...
	dc.w	_data_herotest_big_sprite_planar_pos,_data_herotest_big_sprite_planar_length
	...
	dc.w	_data_testsprite2_sprite_planar_pos,_data_testsprite2_sprite_planar_length
