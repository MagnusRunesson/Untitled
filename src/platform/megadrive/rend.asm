...
VDPRegs:
	...
	dc.w		$856A						; Reg.  5: Sprite attribute table is at $D400
...
;	move.w	#$2002,d0		; We'll use palette #1 and pattern #2,
...
;	dbra	d2,.2			; Loop back to 2
;	
;	dbra	d1,.1			; Loop back to 1
;	
;	move.l	#$40000003,d0
...
FillPlaneB:
	...
	move.w	#$0001,d0		; We'll use palette #0 and pattern #1,
							; don't flip the pattern and set it to
							; low priority.
	moveq	#27,d1			; The screen is 28 cells high
